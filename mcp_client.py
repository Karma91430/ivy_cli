...
async def main():
    ...
    SYSTEM_PROMPT = (
        ...
        "   • git_commit_and_push(message) — ATOMIC: stages + commits + pushes.\n"
        "       PREFER THIS for any 'push my changes' / 'commit and push' request.\n"
        "       TWO-CALL PATTERN:\n"
        "         Call 1: git_commit_and_push()   — no message; tool stages and\n"
        "                                            returns the staged diff for you to inspect.\n"
        "         Call 2: git_commit_and_push(message='<your descriptive 5-10 word message>')\n"
        "       Generic messages ('update', 'fix', 'wip') will be REJECTED — the\n"
        "       tool will return the diff again and ask you to be more specific.\n"
